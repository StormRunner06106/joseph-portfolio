...
const Experience = () => {
  ...
  return (
    <CustomSection title="Experience" id="experience" className="p-0">
      <div
        ref={scrollRef}
      ...
      >
        {experience.map((item, index) => (
          ...
          >
            <div className="flex items-center justify-center w-10 h-10 rounded-full border border-[#e5e7eb] bg-transparent group-[.is-active]:bg-[var(--primary-color)] text-[var(--foreground)] group-[.is-active]:text-[var(--foreground)] shadow shrink-0 md:order-1 md:group-even:-translate-x-1/2 md:group-odd:translate-x-1/2">
              <Icon
